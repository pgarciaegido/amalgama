...
module.exports = yo`<div id="noticia_main">
		...
		<div class="Noticia_comentarios-comentarios-agree">
			<div class="Noticia_comentarios-comentarios-agree-header">
				...
				<div class="Noticia_comentarios-comentarios-agree-header-votes">
					...
					<img src="img/thumbs-up-green.svg" alt="" class="Noticia_comentarios-comentarios-agree-header-votes-icon" />
					<img src="img/thumbs-up-green-filled.svg" alt="" class="Noticia_comentarios-comentarios-agree-header-votes-icon-liked" />
				</div>
			</div>
			...
			<div class="Noticia_comentarios-comentarios-buttons Noticia_hide_on_mobile">
				<button class="Noticia_comentarios-comentarios-buttons-agree">A favor</button>
		...
		<div class="Noticia_comentarios-comentarios-disagree">
			<div class="Noticia_comentarios-comentarios-disagree-header">
				...
				<div class="Noticia_comentarios-comentarios-disagree-header-votes">
					...
					<img src="img/thumbs-down-red.svg" alt="" class="Noticia_comentarios-comentarios-disagree-header-votes-icon" />
					<img src="img/thumbs-down-filled.svg" alt="" class="Noticia_comentarios-comentarios-disagree-header-votes-icon-liked" />
				</div>
			</div>
			...
			<div class="Noticia_comentarios-comentarios-buttons Noticia_hide_on_mobile">
				<button class="Noticia_comentarios-comentarios-buttons-disagree">En contra</button>
				<button class="Noticia_comentarios-comentarios-buttons-comment">Comentar</button>
			</div>
		</div>
	</div>
