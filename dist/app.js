...
/***/ function(module, exports, __webpack_require__) {
	...
	var morphdom = __webpack_require__(19); // efficiently diffs + morphs two DOM elements
	var defaultEvents = __webpack_require__(20); // default events to be copied when dom elements update
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onload = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function noticiaComentarios(n) {
	  return yo(_templateObject3, noticiaComentariosAgree(n), noticiaComentariosDisagree(n));
	}

	// *********** Templates for agree and disagree

	function noticiaComentariosAgree(n) {
	  return yo(_templateObject4, n.agreeVotes, comList());
	}

	function noticiaComentariosDisagree(n) {
	  return yo(_templateObject5, n.disagreeVotes, comList());
	}

	// ************* Template for list of comments

	function comList() {
	  return yo(_templateObject6, comCard());
	}

	// ************* Template for the comment card.

	function comCard(comment, date) {
	  return yo(_templateObject7, date, comment);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  cancelarComments: cancelarComments,
	  enviarComments: enviarComments,
